...
describe(`shouldAutoSubmitPinyinTypedAnswer suite`, () => {
...
describe(`hanziWordToPinyinTypedQuestionOrThrow suite`, () => {
...
describe(`gradeHanziToPinyinTypedQuestion suite`, async () => {
