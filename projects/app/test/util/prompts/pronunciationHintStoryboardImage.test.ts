  ...
  () => {
    test(`snapshot`, () => {
      ...
      expect(fmtImagePromptForSnapshot(prompt)).toMatchInlineSnapshot(`
        ...
        <input>
        {"actor":{"nickname":"Ethan"},"location":{"location":"location","set":{"set":"arrival","name":"arrival name","props":["arrival prop"],"designRules":["arrival design rule"],"canonicalFraming":"arrival canonical framing"}},"scene":{"hook":"hook","premise":"premise","beats":["beat1","beat2"]}}
        </input>
        =====================
