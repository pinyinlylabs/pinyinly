...
describe(`buildLocationSetIdentityImagePrompt`, () => {
  test(`snapshot`, () => {
    const prompt = buildLocationSetIdentityImagePrompt({
      locationSpec: {
        ...
        sets: {
          arrival: {
            set: `arrival`,
            purpose: `used as the guarded front gate entrance`,
          ...
          heart: {
            set: `heart`,
            purpose: `serves as the great hall for gatherings`,
          ...
          below: {
            set: `below`,
            purpose: `functions as a prison-like dungeon below the castle`,
          ...
          ascent: {
            set: `ascent`,
            purpose: `used as the tower's spiral ascent route`,
          ...
          summit: {
            set: `summit`,
            purpose: `serves as the exposed summit lookout`,
