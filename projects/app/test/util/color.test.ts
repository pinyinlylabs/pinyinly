...
describe(`parseCssColorOrThrow suite`, async () => {
  test(`fixtures`, () => {
    const fixtures = [
      [`rgb(1 2 3)`, [1, 2, 3, 1]],
      [`rgb(0 0 0 / 0)`, [0, 0, 0, 0]],
...
describe(`parseScalar suite`, async () => {
  test(`valid fixtures`, () => {
...
describe(`parseHexColor suite`, async () => {
  test(`valid fixtures`, () => {
...
describe(`parseRiveColorPropertyName suite`, async () => {
