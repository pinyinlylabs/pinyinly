...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"演 combines "}
        <_components.strong>{"water + long/vast"}</_components.strong>
        {" to suggest flowing presentation."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        {
          "    | Water radical (氵) - indicates flowing, continuous movement  |\n| "
        }
        <_components.strong>{"寅"}</_components.strong>
        {"    | Respectful/earnest (寅) - suggests serious, dedicated effort |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 演 as "}
        <_components.strong>
          {'"flowing like water in dedicated performance"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"演出"}</_components.strong>
          {' (yǎn chū) - "performance; show; put on a performance"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"演员"}</_components.strong>
          {' (yǎn yuán) - "actor; performer"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"演讲"}</_components.strong>
          {' (yǎn jiǎng) - "speech; lecture; give a speech"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"表演"}</_components.strong>
          {' (biǎo yǎn) - "perform; performance; act"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
