  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Roof radical - representing shelter, protection, home |\n| "}
        <_components.strong>{"口"}</_components.strong>
        {"    | Mouth - representing speech, eating, or opening       |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 害 as "}
        <_components.strong>
          {'"something dangerous getting into your protected space"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"damage that penetrates your protective barriers and causes harm"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"害 represents "}
        <_components.strong>
          {"causing harm, injury, or damage to people, things, or situations"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Direct harm"}</_components.strong>
          {': 害人 (hài rén) - "harm people"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Health effects"}</_components.strong>
        ...
        {"\n"}
        <_components.li>
          <_components.strong>{"Consequences"}</_components.strong>
          {': 害怕 (hàipà) - "fear; be afraid" (literally "fear harm")'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"有害"}</_components.strong>
          {' (yǒuhài) - "harmful; detrimental"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"害怕"}</_components.strong>
          {' (hàipà) - "fear; be afraid"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"害虫"}</_components.strong>
          {' (hàichóng) - "pest; harmful insect"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"伤害"}</_components.strong>
          {' (shānghài) - "injure; wound; harm"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"害处"}</_components.strong>
          {' (hàichu) - "harm; disadvantage"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
