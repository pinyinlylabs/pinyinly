  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {
          "    | Pass, cross over - movement radical 辶 + 呙 (past/through) |\n| "
        }
        <_components.strong>{"去"}</_components.strong>
        {"    | Go, leave, depart - suggesting movement away               |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 过去 as "}
        <_components.strong>
          {'"time that has crossed over and gone away"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"time flowing past us and crossing over into memory"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"过去 represents "}
        <_components.strong>
          {"past time, former periods, and things that have already happened"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        ...
        <_components.li>
          ...
          {': 过去和现在 (guòqù hé xiànzài) - "past and present"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Experience"}</_components.strong>
          {': 过去的经历 (guòqù de jīnglì) - "past experiences"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Historical"}</_components.strong>
          {': 过去的时代 (guòqù de shídài) - "past era"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"在过去"}</_components.strong>
          {' (zài guòqù) - "in the past"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去的"}</_components.strong>
          {' (guòqù de) - "past; former"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去时"}</_components.strong>
          {' (guòqù shí) - "past tense"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去几年"}</_components.strong>
          {' (guòqù jǐ nián) - "the past few years"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"回到过去"}</_components.strong>
          {' (huí dào guòqù) - "return to the past"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
