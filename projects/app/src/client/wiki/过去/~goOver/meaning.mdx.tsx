  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {
          "    | Pass, cross over - movement radical 辶 + 呙 (through)         |\n| "
        }
        <_components.strong>{"去"}</_components.strong>
        {
          "    | Go, direction away - represents movement toward a destination |"
        }
      </_components.p>
      {"\n"}
      <_components.p>
      ...
      <_components.p>
        ...
        <_components.strong>
          {"crossing a boundary or obstacle to reach your destination"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"过去 represents "}
        <_components.strong>
          {"physical movement across space to reach a destination"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        ...
        {"\n"}
        <_components.li>
          <_components.strong>{"Crossing spaces"}</_components.strong>
          {': 过去那边 (guòqu nàbiān) - "go over there"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Visiting"}</_components.strong>
          {': 过去他家 (guòqu tā jiā) - "go over to his house"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Movement commands"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去看看"}</_components.strong>
          {' (guòqu kànkan) - "go over and take a look"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去那边"}</_components.strong>
          {' (guòqu nàbiān) - "go over there"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"你过去"}</_components.strong>
          {' (nǐ guòqu) - "you go over (there)"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去帮忙"}</_components.strong>
          {' (guòqu bāngmáng) - "go over and help"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"过去一下"}</_components.strong>
          {' (guòqu yīxià) - "go over for a moment"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
