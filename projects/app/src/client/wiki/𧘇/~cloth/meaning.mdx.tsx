  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"Fabric drape"}</_components.strong>
        {"     | The shape suggests fabric hanging or draped  |\n| "}
        <_components.strong>{"Garment form"}</_components.strong>
        {"     | The outline resembles a piece of clothing    |\n| "}
        <_components.strong>{"Authority symbol"}</_components.strong>
        {" | Also represents official robes and positions |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 𧘇 as "}
        <_components.strong>
          {'"a piece of cloth or garment hanging down"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"clothing or fabric that hangs in its natural, recognizable form"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "a radical in characters related to clothing, textiles, and authority"
          }
        </_components.strong>
        {". It appears\nin:"}
      </_components.p>
      ...
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Clothing terms"}</_components.strong>
          {": Characters for various garments and fabrics"}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Official positions"}</_components.strong>
          {": Characters related to government and authority"}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Textile processes"}</_components.strong>
          {": Characters about making and working with cloth"}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Status symbols"}</_components.strong>
          {": Characters representing rank and social position"}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      <_components.h2>{"Examples in Compounds"}</_components.h2>
      {"\n"}
      <_components.ul>
        {"\n"}
        <_components.li>
        ...
        {"\n"}
        <_components.li>
          <_components.strong>{"袍"}</_components.strong>
          {' (páo) - "robe; gown"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"裳"}</_components.strong>
          {' (cháng) - "skirt; lower garment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"袖"}</_components.strong>
          {' (xiù) - "sleeve"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"襟"}</_components.strong>
          {' (jīn) - "front of garment"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
