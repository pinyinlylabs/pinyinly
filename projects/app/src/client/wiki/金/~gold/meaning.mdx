Refers to the metallic element gold or denotes metal in general; representing wealth, value, and metallurgy.
...
金 demonstrates how Chinese characters connect physical substances (metal) with abstract concepts (value, strength, precision)!
