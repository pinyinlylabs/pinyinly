  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"地"}</_components.strong>
        {"    | Ground, land, earth (surface) - soil radical 土 + 也     |\n| "}
        <_components.strong>{"球"}</_components.strong>
        {"    | Ball, sphere, globe - jade/king radical 王 + 求 (求 求 ) |"}
      </_components.p>
      {"\n"}
      <_components.p>
      ...
      <_components.p>
        ...
        <_components.strong>
          {"the land we live on is actually a giant ball floating in space"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"地球 represents "}
        <_components.strong>
          {"our planet Earth as a celestial body"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"The planet"}</_components.strong>
          {': 保护地球 (bǎohù dìqiú) - "protect the Earth"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Geography"}</_components.strong>
          {': 地球科学 (dìqiú kēxué) - "Earth science"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Global context"}</_components.strong>
          {': 全地球 (quán dìqiú) - "the entire Earth"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Environmental"}</_components.strong>
          {': 地球环境 (dìqiú huánjìng) - "Earth\'s environment"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"地球村"}</_components.strong>
          {' (dìqiú cūn) - "global village"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"地球日"}</_components.strong>
          {' (dìqiú rì) - "Earth Day"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"地球仪"}</_components.strong>
          {' (dìqiú yí) - "globe (the object)"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"地球表面"}</_components.strong>
          {' (dìqiú biǎomiàn) - "Earth\'s surface"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"地球科学"}</_components.strong>
          {' (dìqiú kēxué) - "Earth science; geoscience"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
