  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Guest, visitor - roof radical 宀 + 各 (each/every)    |\n| "}
        <_components.strong>{"人"}</_components.strong>
        {"    | Person, human being - pictograph of a standing person |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 客人 as "}
        <_components.strong>
          {'"a person who comes under your roof"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"a person who comes to visit and share your home space"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"客人 represents "}
        <_components.strong>
          {"people who visit, stay, or are served in various contexts"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Home visitors"}</_components.strong>
          {': 家里有客人 (jiālǐ yǒu kèrén) - "there are guests at home"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Hotel context"}</_components.strong>
          {': 酒店客人 (jiǔdiàn kèrén) - "hotel guests"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Business"}</_components.strong>
          {': 重要客人 (zhòngyào kèrén) - "important customers"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Formal occasions"}</_components.strong>
          {': 尊贵客人 (zūnguì kèrén) - "honored guests"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"重要客人"}</_components.strong>
          {' (zhòngyào kèrén) - "important guest/customer"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"请客人"}</_components.strong>
          {' (qǐng kèrén) - "invite guests"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"客人来了"}</_components.strong>
          {' (kèrén lái le) - "the guests have arrived"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"贵客人"}</_components.strong>
          {' (guì kèrén) - "honored/distinguished guest"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"招待客人"}</_components.strong>
          {' (zhāodài kèrén) - "receive/entertain guests"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
