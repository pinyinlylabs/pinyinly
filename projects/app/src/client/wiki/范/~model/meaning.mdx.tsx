  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Bamboo radical (⺮) - structured, organized material |\n| "}
        <_components.strong>{"氾"}</_components.strong>
        {"    | Spread, overflow - suggesting scope and boundaries   |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 范 as "}
        <_components.strong>
          {'"a bamboo framework that sets the pattern and boundaries"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"a structured framework that defines proper boundaries and methods"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "models, examples, and defined scopes that guide behavior or activity"
          }
        </_components.strong>
        {". It's used:"}
      </_components.p>
      ...
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Model/example"}</_components.strong>
          {': 模范 (mófàn) - "model; exemplary"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Scope/range"}</_components.strong>
          {': 范围 (fànwéi) - "scope; range; limits"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Pattern"}</_components.strong>
          {': 范式 (fànshì) - "paradigm; pattern"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Standards"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"范围"}</_components.strong>
          {' (fànwéi) - "scope; range; boundary"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"模范"}</_components.strong>
          {' (mófàn) - "model; exemplary person"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"规范"}</_components.strong>
          {' (guīfàn) - "standard; norm; specification"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"范例"}</_components.strong>
          {' (fànlì) - "example; model case"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"示范"}</_components.strong>
          {' (shìfàn) - "demonstrate; show as example"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
