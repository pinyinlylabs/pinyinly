...
Think of 四 as a **room with four walls** (the outer square 口) and an **X mark** in the middle (八) to represent the number four.
...
Unlike 一、二、三 which follow a simple stacking pattern, 四 introduces the concept of enclosed characters, preparing you for more complex character structures.
