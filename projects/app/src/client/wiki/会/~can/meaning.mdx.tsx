...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"会 combines "}
        <_components.strong>{"person + speak"}</_components.strong>
        {" to represent learned ability."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        {"    | Person (人) - indicates human capability              |\n| "}
        <_components.strong>{"云"}</_components.strong>
        {"    | Cloud/speech (云) - represents communication or skill |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 会 as "}
        <_components.strong>
          {'"a person who can speak/communicate effectively"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"我会说中文"}</_components.strong>
          {' (wǒ huì shuō zhōng wén) - "I can speak Chinese"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"他会开车"}</_components.strong>
          {' (tā huì kāi chē) - "He can drive / knows how to drive"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"你会吗？"}</_components.strong>
          {' (nǐ huì ma?) - "Can you do it? / Do you know how?"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"不会"}</_components.strong>
          {" (bù huì) - \"can't; don't know how to\""}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
