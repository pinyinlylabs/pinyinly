...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"有 combines "}
        <_components.strong>{"hand + meat"}</_components.strong>
        {" to represent possession."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        {
          "    | Hand/right hand (又) - indicates grasping or holding      |\n| "
        }
        <_components.strong>{"月"}</_components.strong>
        {"    | Moon/meat (月) - represents something valuable being held |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 有 as "}
        <_components.strong>
          {'"hand holding something valuable"'}
        </_components.strong>
        {" or "}
        <_components.strong>{'"grasping what you own"'}</_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      <_components.ul>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"我有书"}</_components.strong>
          {' (wǒ yǒu shū) - "I have a book"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"有人"}</_components.strong>
          {' (yǒu rén) - "someone; there is someone"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"没有"}</_components.strong>
          {" (méi yǒu) - \"don't have; there isn't\""}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"有意思"}</_components.strong>
          {' (yǒu yì si) - "interesting; meaningful"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
