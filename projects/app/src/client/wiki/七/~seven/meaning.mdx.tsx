...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"七 represents "}
        <_components.strong>{"seven as a cut or division"}</_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      <_components.p>
        ...
        <_components.strong>{"七"}</_components.strong>
        {"    | A horizontal line with a bent hook, like cutting or dividing |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 七 as "}
        <_components.strong>
          {"a knife making a cutting motion"}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"七天"}</_components.strong>
          {' (qī tiān) - "seven days; one week"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"七月"}</_components.strong>
          {' (qī yuè) - "July"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"第七"}</_components.strong>
          {' (dì qī) - "seventh"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"七十"}</_components.strong>
          {' (qī shí) - "seventy"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"七夕"}</_components.strong>
          {" (qī xī) - Chinese Valentine's Day (7th day of 7th lunar month)"}
        </_components.li>
        {"\n"}
        <_components.li>
