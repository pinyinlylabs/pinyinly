Not existing before; made, introduced, or discovered recently or now for the first time; fresh; novel.
...
The character combines the concept of close work (亲) with an axe (斤), suggesting the careful crafting of something new.
...
新 reflects the Chinese appreciation for both tradition and progress - the careful creation of something better!
