The quantitative relationship between two amounts, showing the number of times one value contains or is contained within the other; proportion; ratio; scale.
...
The combination suggests "comparing according to established patterns" or standardized relationships.
...
This creates the image: **measuring and maintaining proper relationships between different parts according to established standards**.

## Core Meaning & Usage

比例 represents **proportional relationships, ratios, and balanced scaling between quantities**. It's used:
...
比例 reflects Chinese aesthetic and philosophical values of balance and harmony. In traditional Chinese art, architecture, and medicine, proper 比例 is essential for beauty and effectiveness. The concept extends to social relationships and governance, where maintaining proper proportional relationships between different groups and interests is seen as crucial for social stability and harmony.
