  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"团"}</_components.strong>
        {"    | Group, circle - enclosure radical 囗 + 寸 (measurement) |\n| "}
        <_components.strong>{"结"}</_components.strong>
        {"    | Knot, tie, bind - silk radical 纟 + 吉 (auspicious)     |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 团结 as "}
        <_components.strong>
          {'"people forming a circle and tying themselves together"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "individuals binding themselves together to form one strong, unified\ngroup"
          }
        </_components.strong>
        {"."}
      </_components.p>
      ...
      <_components.p>
        {"团结 represents "}
        <_components.strong>
          {"unity, solidarity, and collective strength through cooperation"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Group cooperation"}</_components.strong>
          {': 团结合作 (tuánjié hézuò) - "unite and cooperate"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Political concept"}</_components.strong>
          {': 民族团结 (mínzú tuánjié) - "ethnic unity"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Team building"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"团结合作"}</_components.strong>
          {' (tuánjié hézuò) - "unite and cooperate"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"团结一致"}</_components.strong>
          {' (tuánjié yīzhì) - "unite as one"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"民族团结"}</_components.strong>
          {' (mínzú tuánjié) - "ethnic unity"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"团结友爱"}</_components.strong>
          {' (tuánjié yǒu\'ài) - "unity and friendship"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"加强团结"}</_components.strong>
          {' (jiāqiáng tuánjié) - "strengthen unity"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
