  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"路"}</_components.strong>
        {"    | Road, path - foot radical 足 + 各 (each/every direction) |\n| "}
      ...
      <_components.p>
        {"Think of 路边 as "}
        <_components.strong>
          {'"the edge area where people walk alongside the road"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"the edge zone that runs parallel to the main travel route"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"路边 represents "}
        <_components.strong>
          {"the area immediately adjacent to roads and pathways"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Location"}</_components.strong>
          {': 在路边 (zài lùbiān) - "by the roadside"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Parking"}</_components.strong>
          {': 路边停车 (lùbiān tíngchē) - "roadside parking"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Shops"}</_components.strong>
          {': 路边摊 (lùbiān tān) - "roadside stall"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Activities"}</_components.strong>
          {': 路边等车 (lùbiān děng chē) - "wait for a bus by the roadside"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"路边摊"}</_components.strong>
          {' (lùbiān tān) - "roadside stall/vendor"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"路边停车"}</_components.strong>
          {' (lùbiān tíngchē) - "roadside parking"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"在路边"}</_components.strong>
          {' (zài lùbiān) - "by the roadside; at the roadside"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"路边咖啡店"}</_components.strong>
          {' (lùbiān kāfēi diàn) - "roadside café"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"路边等"}</_components.strong>
          {' (lùbiān děng) - "wait by the roadside"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
