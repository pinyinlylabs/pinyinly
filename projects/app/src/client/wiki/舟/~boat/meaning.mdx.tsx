  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"Overall shape"}</_components.strong>
        {" | Resembles a boat hull viewed from the side           |\n| "}
        <_components.strong>{"Curved lines"}</_components.strong>
        {"  | The curves represent the boat's hull and sides       |\n| "}
        <_components.strong>{"Hollow center"}</_components.strong>
        {" | The space inside represents the cargo/passenger area |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 舟 as "}
        <_components.strong>{'"a boat floating on water"'}</_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      <_components.ul>
      ...
      <_components.p>
        ...
        <_components.strong>
          {"the outline of a traditional boat floating peacefully on water"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"舟 represents "}
        <_components.strong>
          {"boats and water vessels, especially traditional ones"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"As standalone"}</_components.strong>
        ...
        <_components.li>
          ...
          {": In characters related to boats and water transport"}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Poetic language"}</_components.strong>
          {': 扁舟 (piǎn zhōu) - "small flat boat" (literary)'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"小舟"}</_components.strong>
          {' (xiǎo zhōu) - "small boat"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"龙舟"}</_components.strong>
          {' (lóng zhōu) - "dragon boat"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"独木舟"}</_components.strong>
          {' (dúmù zhōu) - "canoe" (literally "single-wood boat")'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"舟山"}</_components.strong>
          {' (Zhōushān) - "Zhoushan" (place name meaning "boat mountain")'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"同舟共济"}</_components.strong>
          {
            ' (tóng zhōu gòng jì) - "in the same boat" (idiom about cooperation)'
          }
        </_components.li>
        {"\n"}
      </_components.ul>
