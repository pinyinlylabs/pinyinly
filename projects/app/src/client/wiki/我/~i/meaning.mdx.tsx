...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"我 combines "}
        <_components.strong>{"hand + spear"}</_components.strong>
        {" to represent self-assertion."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        {"    | Hand radical (手) - indicates personal action  |\n| "}
        <_components.strong>{"戈"}</_components.strong>
        {"    | Spear/halberd (戈) - represents weapon or tool |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 我 as "}
        <_components.strong>
          {'"hand holding a spear" or "I defend myself"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"我是学生"}</_components.strong>
          {' (wǒ shì xuéshēng) - "I am a student"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"我叫..."}</_components.strong>
          {' (wǒ jiào...) - "My name is..." / "I am called..."'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"我们"}</_components.strong>
          {' (wǒ men) - "we; us" (我 + plural marker)'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"我的"}</_components.strong>
          {' (wǒ de) - "my; mine"'}
        </_components.li>
        {"\n"}
      </_components.ul>
