  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Person radical - relating to human characteristics       |\n| "}
        <_components.strong>{"象"}</_components.strong>
        {"    | Elephant; also meaning image, appearance, representation |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 像 as "}
        <_components.strong>
          {'"a person showing an image or likeness"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "recognizing the likeness between a person and an image or another\nperson"
          }
        </_components.strong>
        {"."}
      </_components.p>
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "resemblance, similarity, and comparison of appearance or characteristics"
          }
        </_components.strong>
        {". It's\nused:"}
      </_components.p>
      ...
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Physical resemblance"}</_components.strong>
          {': 他像他父亲 (tā xiàng tā fùqīn) - "He looks like his father"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Comparison"}</_components.strong>
          {': 像苹果一样 (xiàng píngguǒ yīyàng) - "like an apple"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Seeming"}</_components.strong>
          {': 看像 (kàn xiàng) - "seems like; appears to be"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Approximation"}</_components.strong>
          {': 像这样 (xiàng zhèyàng) - "like this; in this manner"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"看起来像"}</_components.strong>
          {' (kàn qǐlái xiàng) - "looks like; appears to be"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"长得像"}</_components.strong>
          {' (zhǎng de xiàng) - "looks like (in appearance)"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"听起来像"}</_components.strong>
          {' (tīng qǐlái xiàng) - "sounds like"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"像这样"}</_components.strong>
          {' (xiàng zhèyàng) - "like this; in this way"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"不像"}</_components.strong>
          {' (bù xiàng) - "doesn\'t look like; unlike"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
