...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      {"\n"}
      <_components.p>
        {"不 is pictographic, representing "}
        <_components.strong>{"negation or prohibition"}</_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      <_components.p>
        ...
        {'    | Originally a bird flying upward, now symbolizing "no/not" |'}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 不 as "}
        <_components.strong>
          {'"crossing out" or "blocking something"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"不是"}</_components.strong>
          {' (bù shì) - "is not; am not; are not"'}
        </_components.li>
        {"\n"}
        <_components.li>
        ...
        {"\n"}
        <_components.li>
          <_components.strong>{"不知道"}</_components.strong>
          {' (bù zhī dào) - "don\'t know"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"不用"}</_components.strong>
          {' (bù yòng) - "don\'t need to; no need"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
