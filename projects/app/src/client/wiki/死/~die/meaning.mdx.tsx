...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      <_components.p>{"To cease living; to die; dead; death."}</_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>{"歹"}</_components.strong>
        {"    | Evil, bad, deterioration - relates to death/decay   |\n| "}
        <_components.strong>{"匕"}</_components.strong>
        {"    | Dagger, spoon - suggests something sharp or pointed |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 死 as "}
        <_components.strong>
          {'"when life deteriorates and ends"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"the transition from living to no longer living"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"死 represents "}
        <_components.strong>
          {"death, dying, and the state of being dead"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Literal death"}</_components.strong>
          {': 死了 (sǐ le) - "died; is dead"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"State of being"}</_components.strong>
          {': 死的 (sǐ de) - "dead (adjective)"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Extreme emphasis"}</_components.strong>
          {
            ': 累死了 (lèi sǐ le) - "extremely tired" (literally "tired to death")'
          }
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Fixed expressions"}</_components.strong>
          {': 死心 (sǐxīn) - "give up hope" (literally "dead heart")'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"死了"}</_components.strong>
          {' (sǐ le) - "died; is dead"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"死人"}</_components.strong>
          {' (sǐrén) - "dead person"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"生死"}</_components.strong>
          {' (shēngsǐ) - "life and death"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"死心"}</_components.strong>
          {' (sǐxīn) - "give up hope; lose heart"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"死记"}</_components.strong>
          {' (sǐjì) - "memorize by rote" (literally "dead memorize")'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
