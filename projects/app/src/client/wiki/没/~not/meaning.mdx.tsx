...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"没 combines "}
        <_components.strong>{"water + gone"}</_components.strong>
        {" to show disappearance or absence."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        {
          "    | Water radical (氵) - indicates flowing or disappearing      |\n| "
        }
        <_components.strong>{"殳"}</_components.strong>
        {"    | Gone/disappeared (殳) - suggests something that was removed |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 没 as "}
        <_components.strong>
          {'"water that has flowed away" or "what was there is now gone"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"没有"}</_components.strong>
          {" (méi yǒu) - \"don't have; there isn't; no\""}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"没关系"}</_components.strong>
          {' (méi guān xi) - "it doesn\'t matter; no problem"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"没事"}</_components.strong>
          {" (méi shì) - \"it's okay; no problem; nothing's wrong\""}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"我没去"}</_components.strong>
          {' (wǒ méi qù) - "I didn\'t go"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
