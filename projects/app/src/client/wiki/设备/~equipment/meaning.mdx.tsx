  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"设"}</_components.strong>
        {
          "    | To establish, set up - speech radical 讠+ 殳 (weapon/action) |\n| "
        }
        <_components.strong>{"备"}</_components.strong>
        {"    | To prepare, ready - person 亻+ 备 (preparation/readiness)    |"}
      </_components.p>
      {"\n"}
      <_components.p>
      ...
      <_components.p>
        {"Think of 设备 as "}
        <_components.strong>
          {'"things set up and prepared for use"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"tools and machinery that are set up and ready to use"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "equipment, facilities, and apparatus prepared for specific functions"
          }
        </_components.strong>
        {". It's used:"}
      </_components.p>
      ...
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Industrial equipment"}</_components.strong>
          {': 生产设备 (shēngchǎn shèbèi) - "production equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Medical facilities"}</_components.strong>
          {': 医疗设备 (yīliáo shèbèi) - "medical equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Technology"}</_components.strong>
          {': 电子设备 (diànzǐ shèbèi) - "electronic equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Infrastructure"}</_components.strong>
          {': 基础设备 (jīchǔ shèbèi) - "basic facilities"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"医疗设备"}</_components.strong>
          {' (yīliáo shèbèi) - "medical equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"办公设备"}</_components.strong>
          {' (bàngōng shèbèi) - "office equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"安全设备"}</_components.strong>
          {' (ānquán shèbèi) - "safety equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"通信设备"}</_components.strong>
          {' (tōngxìn shèbèi) - "communication equipment"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"设备管理"}</_components.strong>
          {' (shèbèi guǎnlǐ) - "equipment management"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
