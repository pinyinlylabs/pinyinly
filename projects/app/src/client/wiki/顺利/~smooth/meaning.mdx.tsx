  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"顺"}</_components.strong>
        {
          "    | Follow, along with - head radical 页 + 川 (flowing river) |\n| "
        }
        <_components.strong>{"利"}</_components.strong>
        {"    | Sharp, advantage, benefit - knife radical 刂 + 禾 (grain) |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 顺利 as "}
        <_components.strong>
          {'"flowing like a river with the sharp advantage of a good current"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"moving forward easily because everything is flowing in your favor"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"顺利 represents "}
        <_components.strong>
          {"smooth progress without obstacles or difficulties"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Process description"}</_components.strong>
          {': 很顺利 (hěn shùnlì) - "very smooth; going very well"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Wishes"}</_components.strong>
          {': 祝你顺利 (zhù nǐ shùnlì) - "wish you success"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Completion"}</_components.strong>
          {': 顺利完成 (shùnlì wánchéng) - "complete successfully"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Progress reports"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"工作顺利"}</_components.strong>
          {' (gōngzuò shùnlì) - "work is going smoothly"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"顺利完成"}</_components.strong>
          {' (shùnlì wánchéng) - "complete successfully"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"一切顺利"}</_components.strong>
          {' (yīqiè shùnlì) - "everything is going well"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"祝你顺利"}</_components.strong>
          {' (zhù nǐ shùnlì) - "wish you success"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"进展顺利"}</_components.strong>
          {' (jìnzhǎn shùnlì) - "progress is smooth"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
