...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      {"\n"}
      <_components.p>
        {"革 is a pictograph representing "}
        <_components.strong>{"treated animal hide"}</_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      <_components.p>
        ...
        <_components.strong>{"革"}</_components.strong>
        {
          "    | Originally showed stretched animal skin with texture markings |"
        }
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 革 as "}
        <_components.strong>
          {"animal skin being processed and transformed"}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      {"\n"}
      <_components.p>
        <_components.strong>{'As "leather":'}</_components.strong>
      </_components.p>
      {"\n"}
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"皮革"}</_components.strong>
          {' (pí gé) - "leather; hide"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"革制品"}</_components.strong>
          {' (gé zhì pǐn) - "leather goods"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
      <_components.p>
        <_components.strong>{'As "reform/revolutionize":'}</_components.strong>
      </_components.p>
      {"\n"}
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"改革"}</_components.strong>
          {' (gǎi gé) - "reform; transformation"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"革命"}</_components.strong>
          {' (gé mìng) - "revolution"'}
        </_components.li>
        {"\n"}
      </_components.ul>
