  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"改"}</_components.strong>
        {"    | Change, correct - hand radical 攵 + 己 (self)          |\n| "}
        <_components.strong>{"进"}</_components.strong>
        {"    | Advance, enter - movement radical 辶 + 井 (well/order) |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 改进 as "}
        <_components.strong>
          {'"making changes to move forward and advance"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"making thoughtful changes that lead to better results and progress"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"改进 represents "}
        <_components.strong>
          {"the process of making positive changes to achieve better results"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Work improvement"}</_components.strong>
          {': 改进工作 (gǎijìn gōngzuò) - "improve work"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Product enhancement"}</_components.strong>
          {': 改进产品 (gǎijìn chǎnpǐn) - "improve products"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Process upgrade"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"改进工作"}</_components.strong>
          {' (gǎijìn gōngzuò) - "improve work performance"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"改进技术"}</_components.strong>
          {' (gǎijìn jìshù) - "improve technology"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"改进方法"}</_components.strong>
          {' (gǎijìn fāngfǎ) - "improve methods"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"不断改进"}</_components.strong>
          {' (bùduàn gǎijìn) - "continuously improve"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"改进措施"}</_components.strong>
          {' (gǎijìn cuòshī) - "improvement measures"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
