  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Face, correct, pair - small 小 + 寸 (inch/measure)   |\n| "}
        <_components.strong>{"待"}</_components.strong>
        {"    | Wait, treat, receive - step radical 彳 + 寺 (temple) |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 对待 as "}
        <_components.strong>
          {'"facing someone properly and treating them with care"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "consciously choosing to face someone and treat them with appropriate care\nand respect"
          }
        </_components.strong>
        {"."}
      </_components.p>
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "the manner of treating, handling, or behaving toward people or situations"
          }
        </_components.strong>
        {". It's\nused:"}
      </_components.p>
      ...
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Personal treatment"}</_components.strong>
          {': 对待朋友 (duìdài péngyou) - "treat friends"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Professional handling"}</_components.strong>
          {': 对待工作 (duìdài gōngzuò) - "approach work"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Attitude expression"}</_components.strong>
          {': 认真对待 (rènzhēn duìdài) - "treat seriously"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Social behavior"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"认真对待"}</_components.strong>
          {' (rènzhēn duìdài) - "treat seriously; take seriously"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"平等对待"}</_components.strong>
          {' (píngděng duìdài) - "treat equally"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"对待客人"}</_components.strong>
          {' (duìdài kèrén) - "treat guests"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"如何对待"}</_components.strong>
          {' (rúhé duìdài) - "how to treat/handle"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"友好对待"}</_components.strong>
          {' (yǒuhǎo duìdài) - "treat in a friendly manner"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
