  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"甘"}</_components.strong>
        {
          "    | Sweet, pleasant - represents the basic taste of sweetness |\n| "
        }
        <_components.strong>{"舌"}</_components.strong>
        {"    | Tongue - the organ that tastes sweetness                  |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        ...
        <_components.strong>
          {"your tongue experiencing the delightful sensation of sweetness"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"甜 represents "}
        <_components.strong>
          {"sweetness and pleasant taste sensations"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Taste description"}</_components.strong>
          {': 很甜 (hěn tián) - "very sweet"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Sweet foods"}</_components.strong>
          {': 甜点 (tiándiǎn) - "dessert; sweet pastry"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Sweet drinks"}</_components.strong>
          {': 甜水 (tiánshuǐ) - "sweet water/drinks"'}
        </_components.li>
        {"\n"}
        <_components.li>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"甜点"}</_components.strong>
          {' (tiándiǎn) - "dessert; pastry"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"甜蜜"}</_components.strong>
          {' (tiánmì) - "sweet; romantic; blissful"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"甜食"}</_components.strong>
          {' (tiánshí) - "sweet food; confectionery"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"甜美"}</_components.strong>
          {' (tiánměi) - "sweet and beautiful"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"甜心"}</_components.strong>
          {' (tiánxīn) - "sweetheart; darling"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
