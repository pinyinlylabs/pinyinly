  ...
  return (
    <>
      ...
      <_components.p>
        {"八 represents "}
        <_components.strong>
          {"eight as two things separating or dividing"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      <_components.p>
        ...
        {
          "    | Two diagonal strokes spreading apart, like opening or dividing |"
        }
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 八 as "}
        <_components.strong>
          {"two paths diverging or spreading apart"}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"八天"}</_components.strong>
          {' (bā tiān) - "eight days"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"八月"}</_components.strong>
          {' (bā yuè) - "August"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"第八"}</_components.strong>
          {' (dì bā) - "eighth"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"八十"}</_components.strong>
          {' (bā shí) - "eighty"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"发财"}</_components.strong>
          {' (fā cái) - "get rich" sounds similar to 八 (bā)'}
        </_components.li>
        {"\n"}
        <_components.li>
        ...
        {"\n"}
        <_components.li>
          <_components.strong>{"八八"}</_components.strong>
          {' (bā bā) - "bye bye" (informal goodbye, from English)'}
        </_components.li>
        {"\n"}
        <_components.li>
