  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {
          "    | Bamboo radical (⺮) - traditional calculation tools made of bamboo |\n| "
        }
        <_components.strong>{"廾"}</_components.strong>
        {
          "    | Two hands coming together - suggests working/calculating           |\n| "
        }
        <_components.strong>{"目"}</_components.strong>
        {
          "    | Eye - watching, observing the calculation process                  |"
        }
      </_components.p>
      {"\n"}
      <_components.p>
      ...
      <_components.p>
        {"Think of 算 as "}
        <_components.strong>
          {'"using bamboo tools to carefully count and calculate"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "using traditional tools and careful observation to determine precise\nnumbers"
          }
        </_components.strong>
        {"."}
      </_components.p>
      ...
      <_components.p>
        {"算 represents "}
        <_components.strong>
          {"calculation, counting, and mathematical determination"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        ...
        <_components.li>
          ...
          {': 算数学 (suàn shùxué) - "do mathematics"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Counting"}</_components.strong>
          {': 算一算 (suàn yī suàn) - "count it up"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Considering"}</_components.strong>
          {': 算了 (suàn le) - "forget it; never mind"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Planning"}</_components.strong>
          {': 算时间 (suàn shíjiān) - "calculate time"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"算了"}</_components.strong>
          {' (suàn le) - "forget it; never mind"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"算数"}</_components.strong>
          {' (suànshù) - "arithmetic; mathematics"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"计算"}</_components.strong>
          {' (jìsuàn) - "calculate; compute"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"算账"}</_components.strong>
          {' (suànzhàng) - "keep accounts; settle accounts"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"算一算"}</_components.strong>
          {' (suàn yī suàn) - "count up; calculate"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
