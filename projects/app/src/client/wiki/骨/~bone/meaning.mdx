Any of the pieces of hard whitish tissue making up the skeleton; the structural framework that supports the body.
...
骨 represents **fundamental structure and character** - both the physical framework that supports life and the metaphorical backbone that defines integrity.
