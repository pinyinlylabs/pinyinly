...
> **Note:** Many body part characters, such as 肚 (dù) "belly" and 肺 (fèi) "lungs", use a radical that looks like 月 but is actually derived from the "meat" radical (肉). This radical is visually similar to 月, but its meaning and origin are different. Be careful not to confuse the two!
## Cultural Notes
