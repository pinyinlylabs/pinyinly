  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"石"}</_components.strong>
        {
          "    | Stone radical - hard, solid objects                          |\n| "
        }
        <_components.strong>{"并"}</_components.strong>
        {"    | Together, side by side - suggests two things coming together |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 碰 as "}
        <_components.strong>
          {'"stones coming together with a sudden impact"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"the moment when two solid objects suddenly make contact"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"碰 represents "}
        <_components.strong>
          {"sudden contact, collision, and unexpected encounters"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Physical contact"}</_components.strong>
          {': 碰到 (pèng dào) - "bump into; hit against"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Chance encounters"}</_components.strong>
          {': 碰见 (pèng jiàn) - "run into; meet by chance"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Attempts"}</_components.strong>
          {': 碰运气 (pèng yùnqì) - "try one\'s luck"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Problems"}</_components.strong>
          {': 碰上问题 (pèng shàng wèntí) - "encounter problems"'}
        </_components.li>
        {"\n"}
      </_components.ol>
      {"\n"}
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"碰到"}</_components.strong>
          {' (pèng dào) - "bump into; encounter"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"碰见"}</_components.strong>
          {' (pèng jiàn) - "run into; meet by chance"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"碰运气"}</_components.strong>
          {' (pèng yùnqì) - "try one\'s luck"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"碰头"}</_components.strong>
          {' (pèng tóu) - "meet; get together"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"碰巧"}</_components.strong>
          {' (pèng qiǎo) - "by chance; happen to"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
