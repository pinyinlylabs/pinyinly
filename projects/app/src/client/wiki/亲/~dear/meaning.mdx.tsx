  ...
  return (
    <>
      ...
      <_components.p>
        ...
        {"    | Stand close - representing intimate proximity |\n| "}
        <_components.strong>{"木"}</_components.strong>
        {"    | Tree/support - symbolizing emotional support  |\n| "}
        <_components.strong>{"见"}</_components.strong>
        {"    | See/meet - representing face-to-face intimacy |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 亲 as "}
        <_components.strong>
          {'"coming close enough to touch faces with someone you love"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {
            "the tender, intimate moment of physical affection between loved ones"
          }
        </_components.strong>
        {"."}
      </_components.p>
      ...
      <_components.p>
        {"亲 represents "}
        <_components.strong>
          {"affectionate address, intimate actions, and emotional closeness"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Affectionate address"}</_components.strong>
          {': 亲爱的 (qīn\'ài de) - "dear; beloved"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Physical affection"}</_components.strong>
          {': 亲吻 (qīnwěn) - "kiss"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Emotional closeness"}</_components.strong>
          {': 亲切 (qīnqiè) - "kind; warm; cordial"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Personal involvement"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"亲爱的"}</_components.strong>
          {' (qīn\'ài de) - "dear; beloved (term of endearment)"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"亲吻"}</_components.strong>
          {' (qīnwěn) - "kiss"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"亲切"}</_components.strong>
          {' (qīnqiè) - "kind; warm; cordial"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"亲身"}</_components.strong>
          {' (qīnshēn) - "personal; firsthand"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"亲近"}</_components.strong>
          {' (qīnjìn) - "close to; intimate with"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
