...
function _createMdxContent(props: any) {
  ...
  return (
    <>
      ...
      <_components.p>
        {"合适 combines "}
        <_components.strong>{"join + suitable"}</_components.strong>
        {" to express perfect fit."}
      </_components.p>
      {"\n"}
      <_components.p>
        {
        ...
        <_components.strong>{"合"}</_components.strong>
        {"    | Join; combine; fit together (suggests harmony and unity) |\n| "}
        <_components.strong>{"适"}</_components.strong>
        {"    | Suitable; appropriate; fit (indicates proper match)      |"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"Think of 合适 as "}
        <_components.strong>{'"fits together perfectly"'}</_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      <_components.ul>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"这衣服很合适"}</_components.strong>
          {' (zhè yī fú hěn hé shì) - "these clothes fit well"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"这个时间合适吗？"}</_components.strong>
          {' (zhè gè shí jiān hé shì ma?) - "is this time suitable?"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"找个合适的工作"}</_components.strong>
          {' (zhǎo gè hé shì de gōng zuò) - "find a suitable job"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"不太合适"}</_components.strong>
          {' (bù tài hé shì) - "not very appropriate"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
