  ...
  return (
    <>
      ...
      <_components.p>
        ...
        <_components.strong>{"Tree shape"}</_components.strong>
        {
          "       | Represents a young tree with branches not fully formed |\n| "
        }
        <_components.strong>{"Top branches"}</_components.strong>
        {"     | Short branches showing incomplete development          |\n| "}
        <_components.strong>{"Growth potential"}</_components.strong>
        {" | Shows something in process but not finished            |"}
      </_components.p>
      {"\n"}
      <_components.p>
        {
      ...
      <_components.p>
        {"Think of 未 as "}
        <_components.strong>
          {'"a young tree that hasn\'t finished growing"'}
        </_components.strong>
        {":"}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        ...
        <_components.strong>
          {"growth and potential that hasn't yet been fully realized"}
        </_components.strong>
        {"."}
      </_components.p>
      {"\n"}
      ...
      <_components.p>
        {"未 represents "}
        <_components.strong>
          {"incompleteness, future potential, and things not yet accomplished"}
        </_components.strong>
        {". It's used:"}
      </_components.p>
      {"\n"}
      <_components.ol>
        {"\n"}
        <_components.li>
          <_components.strong>{"Not yet"}</_components.strong>
          {': 未来 (wèilái) - "future; not yet come"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Incomplete action"}</_components.strong>
          {': 未完成 (wèi wánchéng) - "not yet completed"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Future possibility"}</_components.strong>
          {': 未知 (wèizhī) - "unknown; not yet known"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"Negation"}</_components.strong>
      ...
      <_components.ul>
        {"\n"}
        <_components.li>
          <_components.strong>{"未来"}</_components.strong>
          {' (wèilái) - "future; the time to come"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"未知"}</_components.strong>
          {' (wèizhī) - "unknown; uncertain"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"未必"}</_components.strong>
          {' (wèibì) - "not necessarily; may not"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"未完成"}</_components.strong>
          {' (wèi wánchéng) - "incomplete; unfinished"'}
        </_components.li>
        {"\n"}
        <_components.li>
          <_components.strong>{"未曾"}</_components.strong>
          {' (wèicéng) - "never; not yet"'}
        </_components.li>
        {"\n"}
      </_components.ul>
      {"\n"}
