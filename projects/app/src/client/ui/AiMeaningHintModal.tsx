...
export function AiMeaningHintModal({
  ...
  const initialRequestInputRef = useRef({
    hanzi,
    meaning: {
  ...
  const visualPrompt = buildMeaningHintPrompt({
    hanzi,
    meaning: {
      hanziWord: meaning.hanziWord,
      glosses: [...meaning.glosses],
      ...
      {({ dismiss }) => (
        <View className="flex-1 bg-bg">
          ...
          <ScrollView className="flex-1" contentContainerClassName="gap-4 p-4">
            ...
            <AiPromptPreview
              description="Prompt text generated from the same builders used by AI hint generation."
              sections={[
                {
                  title: `Visual`,
