...
const allIcons = [
  ...
  require(`../../assets/icons/arrow-right-down.svg`),
  ...
  require(`../../assets/icons/chevron-left.svg`),
  require(`../../assets/icons/chevron-right.svg`),
  require(`../../assets/icons/chevron-up.svg`),
  require(`../../assets/icons/circle-warning.svg`),
  ...
  require(`../../assets/icons/flash.svg`),
  ...
  require(`../../assets/icons/note-2.svg`),
