...
export const demos: Record<string, FunctionComponent> = {
  ...
  [`QuickSearchButton`]: lazyDemo(() => import(`../../../client/ui/QuickSearchButton.demo`)),
  [`QuickSearchModal`]: lazyDemo(() => import(`../../../client/ui/QuickSearchModal.demo`)),
  ...
  [`QuizQueueLozenge`]: lazyDemo(() => import(`../../../client/ui/QuizQueueLozenge.demo`)),
  ...
  [`WikiHanziCharacterMeaning`]: lazyDemo(() => import(`../../../client/ui/WikiHanziCharacterMeaning.demo`)),
