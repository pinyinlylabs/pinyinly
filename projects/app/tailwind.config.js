  ...
  theme: {
    ...
    colors: {
      ...
      body: {
        ...
        bg15: `rgb(from color-mix(in oklab, var(--color-body) 15%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg20: `rgb(from color-mix(in oklab, var(--color-body) 20%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg25: `rgb(from color-mix(in oklab, var(--color-body) 25%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg30: `rgb(from color-mix(in oklab, var(--color-body) 30%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg35: `rgb(from color-mix(in oklab, var(--color-body) 35%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg40: `rgb(from color-mix(in oklab, var(--color-body) 40%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg45: `rgb(from color-mix(in oklab, var(--color-body) 45%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg50: `rgb(from color-mix(in oklab, var(--color-body) 50%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg55: `rgb(from color-mix(in oklab, var(--color-body) 55%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg60: `rgb(from color-mix(in oklab, var(--color-body) 60%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg65: `rgb(from color-mix(in oklab, var(--color-body) 65%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg70: `rgb(from color-mix(in oklab, var(--color-body) 70%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg75: `rgb(from color-mix(in oklab, var(--color-body) 75%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg80: `rgb(from color-mix(in oklab, var(--color-body) 80%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
        bg85: `rgb(from color-mix(in oklab, var(--color-body) 85%, var(--color-background)) r g b / calc(alpha * <alpha-value>))`,
